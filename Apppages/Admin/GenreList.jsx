...
//   console.log(genres.allGenres)
  ...
  const handleCreateGenre = async (e) => {
    ...
    try {
      ...
      if (result.error) {
        ...
        setName("");
        console.log(result)
        toast.success(`${result.success.name} is successfully created.`);
        refetch();
      }
    } catch (error) {
      console.error(error);
  ...
  const handleUpdateGenre = async (e) => {
    ...
    try {
      ...
      if (result.error) {
        ...
        toast.success(`Genre is updated to ${result.success.name} `);
        refetch();
  ...
  return (
    <div className="lg:ml-[10rem] ml-5 flex flex-col md:flex-row">
      <div className="md:w-3/4 p-3">
        <h1 className="text-5xl font-bold mb-3">Manage Genres</h1>
        <GenreForm
          value={name}
          setValue={setName}
