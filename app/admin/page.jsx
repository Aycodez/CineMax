                ...
                <div className="fcjc h-full">
                  ...
                  <div className="mt-3 text-[0.6rem] fc">
                    <Link
                      ...
                      className="bg-red-600 hover:bg-red-900 text-white font-bold p-2 lg:px-4  rounded-lg"
                    >
                      Update Movie
                    </Link>
                    <Link
                      href={`/admin/movies/delete/${movie._id}`}
                      className="bg-[#D3D3D3] hover:bg-slate-600 border border-black font-bold p-2 lg:px-4 rounded-lg"
                    >
                      Delete Movie
                    </Link>
                  </div>
